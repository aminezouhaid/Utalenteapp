...
<form  class="d-flex justify-content-center  flex-column   block-example border border-right-0 border-dark "  style=" height:80%; box-shadow: 10px 5px 5px #464848; border-radius: 30px; " action="<?php echo URLROOT ?>/users/login" method="post">
...
<div class="form-group"    style="margin-bottom:20px;">
  ...
  <p style="margin:10px;">Not have an account ? <a href="<?php echo URLROOT ?>/users/register ?>">Register</a></p>
