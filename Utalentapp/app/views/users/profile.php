...
<body>
    ...
    <div class="imgprfle1" >
<img class="imgeprfile"src="data:image/*;base64,<?php echo $data['img'] ?>" alt="img">
</div>
    <div  class="toot">
        <div>
...
<h5> categorie :  <?php echo$data['user_categorie'] ; ?></h5>
  ...
  <a href="<?php echo URLROOT   ?>/users/updateprfl/"><button type="button"  class="btn btn-success">Update</button></a>
  </div>
</div>
